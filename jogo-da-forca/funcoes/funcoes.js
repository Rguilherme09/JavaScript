...
function atualizarPalavraOculta(palavraOculta, letraDigitada, palavraEscolhida){
    let palavraOcultaArray = palavraOculta.split('')        // Converte a palavra oculta em array de caracteres

    for (let i = 0; i < palavraEscolhida.length; i++){      // Loop que continua até o tamanho final da palavra escolhida
        if (palavraEscolhida[i] === letraDigitada){         // Verifica se cada letra da palavra escolhida é igual a letra digitada
